...
import 'package:flclashm/product/ui/dashboard/stats_grid_view.dart';
...
class DashboardView extends ConsumerStatefulWidget {
  const DashboardView({
    super.key,
    required this.heroConnectBuilder,
    required this.startButtonBuilder,
  });

  final WidgetBuilder heroConnectBuilder;
  final WidgetBuilder startButtonBuilder;
            ...
            return Expanded(
              child: Column(
                children: [
                  ...
                  widget.startButtonBuilder(context),
                ],
              ),
            );
          }
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  widget.heroConnectBuilder(context),
                ],
              ),
            ),
          );
