...
class StormDnsSettingsResolver {
  ...
  StormDnsSettings resolve(Map<String, dynamic> config, {required String node}) {
    ...
    return StormDnsSettings(
      ...
      resolverStrategy: _string(policy['strategy']) ?? 'least-loss',
...
String buildStormDnsToml({
  ...
  final startup = stormDnsStartupModes[settings.startupMode]!;
  final encryptionMethod = stormDnsEncryptionMethods[settings.encryption];
  final strategy = stormDnsResolverStrategies[settings.resolverStrategy];
  final uploadCompression =
      stormDnsCompressionTypes[settings.uploadCompression];
  final downloadCompression =
      stormDnsCompressionTypes[settings.downloadCompression];
