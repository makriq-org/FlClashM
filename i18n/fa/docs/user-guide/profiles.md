...
StormDNS ترافیک TCP را در پرس‌وجوهای معمولی DNS به یک رزالور مجاز می‌پیچد — تا اتصال از لیست‌های سفید بگذرد. هدف همان هدف OlcRTC است، اما حامل فرق دارد: شبکه‌ای که تنها DNS را عبور می‌دهد. این نود **به‌طور محسوسی کندتر** از بقیه است.
