...
کلاینت راهبردهای فهرست ByeByeDPI را می‌آزماید و نتیجهٔ کارآمد را برای هر شبکهٔ فیزیکی جداگانه نگه می‌دارد؛ با بازگشت به شبکهٔ شناخته‌شده همان نتیجه فوراً استفاده می‌شود. شناسه فقط از نوع اتصال، DNS و مسیر ساخته می‌شود و به مجوز SSID یا اطلاعات اپراتور نیاز ندارد؛ حداکثر ۱۶ شبکهٔ اخیر نگه‌داری می‌شود.
