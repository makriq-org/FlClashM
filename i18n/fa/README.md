...
> [!WARNING]
> این پروژه در حال توسعهٔ فعال است. برخی قابلیت‌ها هنوز در حال بهبودند و رابط کاربری ممکن است تغییر کند.
...
> [!NOTE]
> به‌روزرسان داخلی به‌طور پیش‌فرض فقط نسخه‌های پایدار را نشان می‌دهد. نسخه‌های پیش‌انتشار را می‌توان در تنظیمات فعال کرد.
