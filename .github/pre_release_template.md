## 🧪 FlClashM VERSION · предварительная сборка

> ⚠️ Тестовая версия — возможны нестабильности. Встроенный апдейтер по умолчанию её не показывает; включите пред-релизы в настройках, чтобы получать такие обновления.
